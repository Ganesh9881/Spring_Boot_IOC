...
public class BootIocProj07MiniProjectOracleMySqlLooseCouplingApplication {

	public static void main(String[] args) {
		System.out.println("BootIocProj05LayeredAppMiniProjectRealtimeDIApplication.main() (start)");
		//get IOC container
		try(ConfigurableApplicationContext ctx=
				 SpringApplication.run(BootIocProj07MiniProjectOracleMySqlLooseCouplingApplication.class, args);
