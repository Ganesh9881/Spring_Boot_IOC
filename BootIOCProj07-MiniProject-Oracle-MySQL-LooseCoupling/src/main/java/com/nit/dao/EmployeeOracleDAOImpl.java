...
public class EmployeeOracleDAOImpl implements IEmployeeDAO
{
	...
	public List<Employee> showEmployeesByDesgs(String desg1, String desg2, String desg3) throws Exception {
		System.out.println("EmployeeOracleDAOImpl.showEmployeesByDesgs()");
				...
				)
		{
			...
			{
				//cipy resultset object records list of java bean class
				list = new ArrayList();
				
				while(rs.next())
				{
					//copy each record of resultset obj to employee obj
